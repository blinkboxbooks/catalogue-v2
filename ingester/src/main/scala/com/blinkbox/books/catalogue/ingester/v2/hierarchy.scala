...
import com.blinkbox.books.catalogue.common.search.{EsIndexer, EsSearch, Schema}
import com.blinkbox.books.catalogue.ingester.messaging.{V1MessageHandler, V2MessageHandler}
import com.blinkbox.books.catalogue.ingester.parser.{JsonV2IngestionParser, XmlV1IngestionParser}
